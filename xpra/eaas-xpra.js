var loadXpra = function (xpraUrl, xpraPath, xpraConf, eaasClientObj) {
    ...
    function init_client() {
        ...
        var path = getparam("path") || xpraUrl.substring(xpraUrl.indexOf(port) + 4, xpraUrl.length);
        console.log("xpra path: ", path);
        ...
        var debug_main = getboolparam("debug_main", true);
        if(!debug_main) {
            client.callback_close = function(reason) {
                if(submit) {
                    ...
                    console.log("redit was called to connect.html \n Probably something went wrong")
                }
            }
        }
