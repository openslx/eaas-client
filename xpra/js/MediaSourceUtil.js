...
var MediaSourceConstants = {
    ...
    PREFERRED_CODEC_ORDER: ["opus+mka", "vorbis+mka", "opus+ogg", "vorbis+ogg", "opus", "vorbis", "speex+ogg", "flac+ogg", "aac+mpeg4", "mp3+mpeg4", "mp3", "flac", "wav", "wave"],
    H264_PROFILE_CODE: {baseline: "42C0", main: "4D40", high: "6400", extended: "58A0"},
    H264_LEVEL_CODE: {"3.0": "1E", 3.1: "1F", 4.1: "29", 5.1: "33"},
    READY_STATE: {0: "NOTHING", 1: "METADATA", 2: "CURRENT DATA", 3: "FUTURE DATA", 4: "ENOUGH DATA"},
    NETWORK_STATE: {0: "EMPTY", 1: "IDLE", 2: "LOADING", 3: "NO_SOURCE"},
    ERROR_CODE: {
    ...
    AURORA_CODECS: {wav: "lpcm", mp3: "mp3", flac: "flac", "aac+mpeg4": "mp4a"}
};
var MediaSourceUtil = {
