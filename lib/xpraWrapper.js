...
const xpraPath = new URL("../xpra-html5/", import.meta.url);
  ...
  construct(target, argArray, newTarget) {
    ...
    switch (url) {
      case "js/lib/wsworker_check.js":
        ...
        break;
      case "js/Protocol.js":
        argArray[0] = String(new URL("eaas-xpra-worker.js", import.meta.url));
        break;
    }
    return Reflect.construct(target, argArray, newTarget);
  },
...
export async function prepareAndLoadXpra(xpraUrl, xpraConf) {
  ...
  await Promise.all([
    ...
    loadScript(new URL("./eaas-xpra.js", import.meta.url)),
