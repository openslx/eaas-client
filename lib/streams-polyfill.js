import { WritableStream } from "../third_party/web-streams-polyfill/ponyfill.es2018.mjs.js";
...
if (!ReadableStream.prototype.pipeThrough) ReadableStream.prototype.pipeThrough = function ({ writable, readable }) {
    this.pipeTo(writable);
    return readable;
};

if (!ReadableStream.prototype.pipeTo) ReadableStream.prototype.pipeTo = async function (writable) {
