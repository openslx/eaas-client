    ...
    async loadNetworkEnvironment(networkEnvironment) {
        ...
        for (const networkElement of networkEnvironment.emilEnvironments) {
            ...
            if (env.runtimeId) {
                ...
                component = new MachineComponentBuilder(env.runtimeId, "public");
            ...
            component.setHasOutput(networkElement.hasOutput);
        ...
        if (networkEnvironment.smbServiceId) {
            ...
            if(!smbEnvironment)
                throw new Error("smb environment " + networkEnvironment.smbServiceId + " not available.");
        ...
        if (networkEnvironment.linuxArchiveProxyEnvId) {
            ...
            if(!linuxArchiveProxyEnvironment)
                throw new Error("linux archive proxy environment " + linuxArchiveProxyEnvId + " not available");
