...
export class NetworkBuilder {
    ...
    async buildDnsService(dnsEnvironment, networkId) 
    {
        ...
        const networkConfiguration = await _fetch(`${this.API_URL}/network-environments/${networkId}?json=true`);
        console.log(JSON.stringify(networkConfiguration));
        runtimeBuilder.addUserEnvironment(`EAAS_NETWORK_CONFIG=${JSON.stringify(networkConfiguration)}`);
