...
export class MachineComponentBuilder extends ComponentBuilder {
     ...
     * @param {"image" | "object" | "software" | "user-medium"} imageKind
     * @param {string} id
     * @prama {{archive?: string, mediumType?: string, name?: string, url?: string}} data
     */
    setDriveAssignment(driveIndex, imageKind, id, data = {}) {
        if (!this.drives)
            this.drives = [];
        ...
        const drive = {
            ...
            data: {
                ...
                ...data
                // archive if object
                // mediumType ("hdd", "cdrom", "floppy"), name?, url if user-medium
            }
        };
