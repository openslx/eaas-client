...
export class NetworkUtils {
    ...
    {
        const networkEnvironment = await this.getNetorkEnvironment(networkId);
        ...
        if (networkEnvironment.dnsServiceEnvId) {
            ...
            if (env.runtimeId) {
                ...
                input.content = [{
                    "action": "copy",
                    "url": sessionStorage.DEBUG_network_json_url ? sessionStorage.DEBUG_network_json_url : url,
