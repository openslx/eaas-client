...
export class ComponentSession extends EventTarget {
    ...
    async createSnapshot(snapshotRequest) {
        ...
        let result = await _fetch(`${this.API_URL}/components/${this.componentId}/snapshot`, "POST", postReq, this.idToken);
    ...
    async checkpoint(request) {
        ...
        try {
            ...
            let result = await _fetch(`${this.API_URL}/components/${this.componentId}/checkpoint`, "POST", postReq, this.idToken);
            if (result.status === "1")
